public class CreditCardVerification {
    ...
    public boolean isLengthValid(long cardNumber) {
        ...
        if(counter >= 13 && counter <= 16){ isCreditCardValid = true; }
    ...
    public String cardType(long cardNumber) {
        ...
        if(firstDigit == '6'){ cardType = "Discover Card"; }
        if(firstDigit == '3' && secondDigit == '7'){ cardType = "American Express Card"; }
        return cardType;
    }
    ...
    public int [] getArrayOf(long numbers) {
        ...
        for(int index = 0; index < stringNumbersToArray.length; index++){ arrayOfNumbers[index] = Integer.parseInt(stringNumbersToArray[index]); }
        return arrayOfNumbers;
    }

    public int [] doubleSecondElementsRightToLeft(long numbers) {
        int [] arrayOfNumbers = getArrayOf(numbers);
        for(int index = arrayOfNumbers.length - 2; index >= 0; index-=2){ arrayOfNumbers[index] = arrayOfNumbers[index] * 2;}
        return arrayOfNumbers;
    }
    ...
    public int sumOfSecondDigitsRightToLeft(long numbers) {
        ...
        int sum = 0;
        for(int index = arrayOfNumbers.length - 2; index >= 0; index-=2){ sum += arrayOfNumbers[index];}
        return sum;
    }
    ...
    public int sumOfOddPlacedDigitsRightToLeft(long numbers) {
        int []  arrayOfNumbers = doubleSecondElementsRightToLeftNoDoubleDigitElement(numbers);
        int sum = 0;
        for(int index = arrayOfNumbers.length - 1; index >= 0; index-=2){sum += arrayOfNumbers[index];}
        return sum;
    }
